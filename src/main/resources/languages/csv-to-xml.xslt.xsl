...
<!--
    Document   : csv-to-xml.xslt.xsl
    Created on : 
    Author     : https://www.rosettacode.org/wiki/Csv-to-xml.xslt
    Description:
        Here is a general purpose library XSLT 2.0 style-sheet for converting CSV to XML. This is referenced in task CSV_to_HTML_translation https://www.rosettacode.org/wiki/CSV_to_HTML_translation
-->
<!DOCTYPE constants[
